...
var stripe = Stripe('pk_test_51RAoIaLZCUfoBXO0F9zBP6RnyPWtIUpXNQM6IHqZdk9ZRHTs54YKhGhJDzjp3lgMqdzu2MLskljgPPk693ezeT1m00Oqy74xvm');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          console.error('Error redirecting to Stripe:', _context.t0);
          (0, _alerts.showAlert)('error', 'Something went wrong while processing your payment. Please try again.');
        case 12:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          errorMsg = _context.t0.response && _context.t0.response.data && _context.t0.response.data.message || 'Something went wrong!';
...
// Remove signup form listener here
